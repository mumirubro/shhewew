...
- **Smart Product Selection**: Updated to always search ALL products and select the cheapest available paid product (excludes free and out-of-stock items)
...
**`/msh`** - Multiple cards
- Format: `?cards={cc1},{cc2}&site={url}` or `?cards={cc1},{cc2}` (with global URL)
